...
def compute_categorical_crossentropy(AL, Y, epsilon=1e-12):
    """
...
def L_layer_model(X, Y, layers_dims, learning_rate=0.0075, num_epochs=3000, mini_batch_size=64, print_cost=False):
    ...
    for i in range(0, num_epochs):
        ...
        # Print the cost every 50 iterations and for the last iteration
        if print_cost and (i % 50 == 0 or i == num_epochs - 1):
